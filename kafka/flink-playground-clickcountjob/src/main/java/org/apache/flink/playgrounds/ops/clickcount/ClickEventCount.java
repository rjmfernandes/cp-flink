...
public class ClickEventCount {
	...
	public static final Time WINDOW_SIZE = Time.of(WINDOW_SECONDS_SIZE, TimeUnit.SECONDS);
	...
	public static void main(String[] args) throws Exception {
		...
		String inputTopic = params.get("input-topic", TOPIC_INPUT);
		String outputTopic = params.get("output-topic", TOPIC_OUTPUT);
		String brokers = params.get("bootstrap.servers", BOOSTRAP_SERVER);
